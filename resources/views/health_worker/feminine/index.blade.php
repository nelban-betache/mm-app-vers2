            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-baseline mb-md-3" style="margin-bottom: 0 !important;">
                        ...
                        <button type="button" class="btn btn-sm btn-outline-primary mr-2" data-toggle="modal" data-target="#assignFeminineModal"><i class="fa-solid fa-user-tag"></i> Assign Feminine</button>
